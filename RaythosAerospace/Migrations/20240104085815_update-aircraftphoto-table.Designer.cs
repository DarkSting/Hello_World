...
namespace RaythosAerospace.Migrations
{
    ...
    [Migration("20240104085815_update-aircraftphoto-table")]
    partial class updateaircraftphototable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RaythosAerospace.Models.Repositories.AdminRepository.AdminModel", b =>
                {
            ...
            modelBuilder.Entity("RaythosAerospace.Models.Repositories.AirCraftRepository.AirCraftPhoto", b =>
                {
                    ...
                    b.ToTable("AirCraftPhoto");
                });

            modelBuilder.Entity("RaythosAerospace.Models.Repositories.AirCraftRepository.ColorModel", b =>
                {
                    b.Property<string>("ColorId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("RaythosAerospace.Models.Repositories.AirCraftRepository.CustomizationModel", b =>
                {
                    ...
                    b.Property<string>("ExtraModifications")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("RaythosAerospace.Models.Repositories.ProductRepository.ProductModel", b =>
                {
                    b.Property<string>("ProductId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("RaythosAerospace.Models.Repositories.AirCraftRepository.AirCraftModel", b =>
                {
                    b.HasOne("RaythosAerospace.Models.Repositories.AirCraftRepository.ColorModel", "Color")
                        .WithMany()
            ...
            modelBuilder.Entity("RaythosAerospace.Models.Repositories.AirCraftRepository.CustomizationModel", b =>
                {
                    ...
                    b.HasOne("RaythosAerospace.Models.Repositories.AirCraftRepository.EngineModel", "Engine")
                        .WithMany("customize")
                        .HasForeignKey("EngineId");
            ...
            modelBuilder.Entity("RaythosAerospace.Models.Repositories.ProductRepository.ProductModel", b =>
                {
                    ...
                    b.HasOne("RaythosAerospace.Models.Repositories.AirCraftRepository.CustomizationModel", "Customize")
                        .WithOne("Product")
                        .HasForeignKey("RaythosAerospace.Models.Repositories.ProductRepository.ProductModel", "CustomizationId");
