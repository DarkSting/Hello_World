...
const bookingSessionModel = require('../Models/BookingSessionModel');
...
const createBookingSession = async(req,res)=>{
    ...
    const{stationID,bookings,capacity,expiredDate} = req.body;

    const newBookingSession = new bookingSessionModel({
